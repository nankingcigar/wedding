 ...
 * @Last Modified time: 2019-03-08 15:55:33
 */
import * as React from "react";
import { Trans, withTranslation } from "react-i18next";
import { ContentSectionOurStorySectionDictionary as key } from "../../../const/locale";
import { REACT_APP_VENDOR_IMAGE } from "../../../const/variable";
import LocaleComponentBase from '../../locale';

class OurStorySecion extends LocaleComponentBase {
  public render() {
    return (
        ...
        <div className="container">
          ...
          <div className="row story-row">
            ...
            <div className="col-sm-12 col-md-2 text-center story-date-wrapper animation fadeIn">
              ...
              <div className="story-date">
                <div className="date-only">01</div>
                <div className="month-year">04.15</div>
              </div>
          ...
          <div className="row story-row">
            ...
            <div className="col-sm-12 col-md-2 text-center story-date-wrapper animation fadeIn">
              <div className="arrow-left" />
              <div className="story-date">
                <div className="date-only">11</div>
                <div className="month-year">23.16</div>
              </div>
              <div className="arrow-right" />
              <div className="clearboth" />
            </div>
          ...
          <div className="row story-row">
            ...
            <div className="col-sm-12 col-md-2 text-center story-date-wrapper animation fadeIn">
              <div className="arrow-left" />
              <div className="story-date">
                <div className="date-only">23</div>
                <div className="month-year">11.18</div>
              </div>
              <div className="arrow-right" />
              <div className="clearboth" />
            </div>
          ...
          <div className="row story-row">
            ...
            <div className="col-sm-12 col-md-2 text-center story-date-wrapper animation fadeIn">
              <div className="arrow-left" />
              <div className="story-date">
                <div className="date-only">03</div>
                <div className="month-year">18.19</div>
              </div>
              <div className="arrow-right" />
              <div className="clearboth" />
            </div>
...
export default withTranslation()(OurStorySecion);
